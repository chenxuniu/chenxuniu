...
|---|---|---|
| [TokenPowerBench](https://github.com/chenxuniu/TokenPowerBench) | Benchmarking power consumption of LLM inference on multi-node GPU clusters | ⭐ 4 |
| [LLM-Inference-Engine-Benchmark](https://github.com/chenxuniu/LLM-Inference-Engine-Benchmark) | Energy consumption comparison across major LLM serving frameworks | ⭐ 3 |
| [Power_Profiler](https://github.com/chenxuniu/Power_Profiler) | High-frequency GPU node energy monitoring tools | ⭐ 1 |
